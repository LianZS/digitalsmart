    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_column='name', max_length=32, verbose_name='城市名字')),
                ...
                ('weatherpid', models.CharField(db_column='weatherpid', max_length=16, verbose_name='城市区域所对应的天气标识')),
