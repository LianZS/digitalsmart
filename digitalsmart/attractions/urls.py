...
from .peopleflow_view import ScenicPeopleFlowDetail
...
urlpatterns = {
    path("api/", include([
        ...
        path("getLocation_pn_percent_new", ScenicPeopleFlowDetail.get_scenicflow_data_queryset),  # 实时人流接口
        path("getLocation_trend_percent_new", ScenicPeopleFlowDetail.get_scenicflow_trend_queryset),  # 实时人流趋势
        path("getLocation_search_rate", CommentDetail.get_search_heat_queryset),  # 地区全网搜索次数
        path("getLocation_distribution_rate", ScenicPeopleFlowDetail.scence_people_distribution),  # 地区实时人口分布热力图数据
